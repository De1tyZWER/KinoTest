...
<main>
    <section class="promo-banner">
        <div class="container">
            <h2>Новые фильмы каждый век</h2>
            <p>Смотрите худшие фильмы и сериалы в низком качестве</p>
            <button onclick="scrollToNewMovies()">Начать просмотр</button>
        </div>
    </section>
    ...
    <section id="scrollP" class="pop-movies">
        <div class="container">
            <h2>Популярное</h2>
            <div class="movies-grid">
                <div class="movie-card">
